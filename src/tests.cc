...
TEST(S21MatrixTest, CopyEmpty) {
  S21Matrix m1(2, 2), m2;
  m2 = std::move(m1);
  EXPECT_ANY_THROW(S21Matrix m3(m1));

  S21Matrix m_t(2, 2);
  EXPECT_ANY_THROW(m_t(0, -1) = 6.9);
}

TEST(S21MatrixTest, EqualCopy) {
  S21Matrix m1(2, 2), m2;
  m1(0, 0) = 7;
  m1(1, 0) = 2;
  m1(0, 1) = 7;
...
TEST(S21MatrixTest, EqualMove) {
  S21Matrix m1(2, 2), m2, m3;
  m1(0, 0) = 7;
  m1(1, 0) = 2;
  m1(0, 1) = 7;
  m2 = std::move(m1);
...
TEST(S21MatrixTest, FriendMultiply) {
  S21Matrix m1(2, 2), m2;
  m1(0, 0) = 7;
  m1(1, 0) = 2;
  m1(0, 1) = 7;
